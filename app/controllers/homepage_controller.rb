  ...
  def search
    ...
    if @searchword.present?
      ...
      tweets.each do |tweet|
        ...
        response = conn.get "/datatxt/nex/v1/?min_confidence=0.5&lang=en &social.parse_hashtag=True&text=#{tweet.text}&include=image&$app_id=cb93dde4&$app_key=5366ca18b641266f05c0447a0ee8b1a8"
